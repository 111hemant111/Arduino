...
/////********************************RFID and IoT based Smart water vending machine*********************************/////
...
{ 
  ...
  lcd1.begin(16,2);
  lcd1.setCursor(0,0);
  lcd1.print("   So Rugged    ");
  lcd1.setCursor(0,1);
  lcd1.print("   and Agile    ");
  delay(2000);
  lcd1.begin(16,2);
  lcd1.setCursor(0,0);
  lcd1.print("  Final year    ");
  lcd1.setCursor(0,1);
  lcd1.print("  Project ECE   ");
